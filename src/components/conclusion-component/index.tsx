...
const ConclusionComponent: React.FC<ConclusionComponentProps> = ({
  onCompletionChange,
  onNextClick,
  onPrevClick,
  userEmail
}) => {
  const moduleName = "Conclusion"; // The name of the module
    ...
    <div className=" p-3 text-left " data-aos="fade-left">
      <div>
        <div className="d-flex justify-content-between flex-wrap align-content-center">
          <h1 className="  mb-3">
            {" "}
            <strong>Conclusion - Video {numericVideoNumber}</strong>
          </h1>
      ...
      <div style={{ height: "70%", width: "70%" }}>
        <VideoPlayer
          src={videos[6]?.Conclusion[numericVideoNumber - 1]?.url}
          poster={
